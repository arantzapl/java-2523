...
CREATE TABLE `resenas` (
  ...
  `alumno_codigo` int NOT NULL,
  `curso_codigo` int NOT NULL,
  PRIMARY KEY (`id`,`curso_codigo`),
  KEY `fk_resenas_alumno1_idx` (`alumno_codigo`),
  KEY `fk_resenas_curso1_idx` (`curso_codigo`),
  CONSTRAINT `fk_resenas_alumno1` FOREIGN KEY (`alumno_codigo`) REFERENCES `alumno` (`codigo`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_resenas_curso1` FOREIGN KEY (`curso_codigo`) REFERENCES `curso` (`codigo`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `resena` (descripcion, alumno_codigo, curso_codigo) VALUES ('Muy bueno y muy completo', 2, 3), ('Largo, pero satisfactorio', 1, 2), ('Genial, he aprendido muchísimo!', 4, 1);
...
-- Dump completed on 2024-02-29  9:41:11

...
<main class="container">
	...
	<form action="admin/libro" method="post">
		...
		<div class="row mb-3">
			...
			<div class="col-sm">
				<input type="text" class="form-control ${errores.autor != null ? 'is-invalid' : '' }" id="autor" name="autor" value="${libro.autor}">
				<div class="invalid-feedback">${errores.autor}</div>
			</div>
		</div>
		<div class="row mb-3">
			<label for="url-foto" class="col-sm-2 col-form-label">URL Foto</label>
			<div class="col-sm">
				<input type="url" class="form-control" id="url-foto" name="url-foto" value="${libro.urlFoto}">
			</div>
		</div>
		<div class="row mb-3">
